      ...
      return (
        <View>
          ...
          <ListItem
            ...
            onPress={() =>
              this.props.navigation.navigate('SellerRequestDetails', {
                maxe: item.maXe,
                mahd: item.id,
              })
            }>
            ...
            <Body>
              ...
              {item.readed == false && (
                <Text style={{fontSize: 18, paddingTop: 1, fontWeight: 'bold'}}>
                  {item.tenXe}
                </Text>
              )}
            ...
            <Right style={{justifyContent: 'flex-end', marginBottom: 7}}>
              <Text note style={{paddingTop: 10}}>
                {item.ngayLap.toString().substr(0, 10) +
                  ', ' +
                  item.ngayLap.toString().substr(11, 5)}
              </Text>
            </Right>
          </ListItem>
        </View>
